...
public class TennisAgent : Agent
{
    ...
    public override void OnActionReceived(float[] vectorAction)
    {
        ...
        {
            transform.position = new Vector3(-m_InvertMult + transform.parent.transform.position.x, transform.position.y, transform.position.z);
        }
    ...
    public override void Heuristic(float[] actionsOut)
    {
        ...
        actionsOut[1] = Input.GetKey(KeyCode.Space) ? 1f : 0f;
